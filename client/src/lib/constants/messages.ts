...
export const ERROR_MESSAGES = {
  ...
  TECHNICAL_ERROR: "A technical error occurred. Please try again or contact support if the problem persists.",
...
export const INFO_MESSAGES = {
  // Organization
  ORG_PENDING_REVIEW: "Your organization registration is currently under review. Please contact Educard",
