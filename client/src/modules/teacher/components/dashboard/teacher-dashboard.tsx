 ...
 * Role-specific dashboard for teachers showing their classes, student performance,
 * attendance statistics, and upcoming schedule. Uses mock data for demonstration.
 */
